class Transform {
    ...
    applyTransforms() {
        ...
        matrix = this.multiplyMat4(matrix, this.getMatrixTranslation(this.position.x, this.position.y, this.position.z));
        matrix = this.multiplyMat4(matrix, this.getMatrixRotationY(this.rotation.y));
        matrix = this.multiplyMat4(matrix, this.getMatrixRotationX(this.rotation.x));
        matrix = this.multiplyMat4(matrix, this.getMatrixRotationZ(this.rotation.z));
        matrix = this.multiplyMat4(matrix, this.getMatrixScaleNonUniform(this.scale.x, this.scale.y, this.scale.z));
        
        GL.uniformMatrix4fv(WEBGL_APP.shader.propertyLocationModelMatrix, false, matrix);
    }
