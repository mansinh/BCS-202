...
*/
    ...
    getTouchPosition(e) {
        if(e.targetTouches.length > 0){
            this.mousePosition.x = this.remapValue(e.targetTouches[0].pageX, 0, CANVAS.clientWidth, -1, 1);
            this.mousePosition.y = -this.remapValue(e.targetTouches[0].pageY, 0, CANVAS.clientHeight, -1, 1);
        }
    }
